...
[![npm](https://img.shields.io/npm/v/@hztxi/cesium)](https://www.npmjs.com/package/@hztxi/cesium)
...
If you’re building your application using a module bundler such as Webpack, Parcel, or Rollup, you can install this fork via the [`@hztxi/cesium` npm package](https://www.npmjs.com/package/@hztxi/cesium):

```sh
npm install @hztxi/cesium --save
```
...
```js
import { Viewer } from "@hztxi/cesium";
import "@hztxi/cesium/Build/Cesium/Widgets/widgets.css";
...
- [`@hztxi/cesium-engine`](./packages/engine/README.md) - CesiumJS's core, rendering, and data APIs
- [`@hztxi/cesium-widgets`](./packages/widgets/README.md) - A widgets library for use with CesiumJS
